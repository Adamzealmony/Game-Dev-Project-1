...
class TiledLevel_2 extends TiledMap
{
	...
	public function new(TiledLevel_2:FlxTiledMapAsset, state:PlayState_2) 
	{
		super(TiledLevel_2);
	...
	public function loadObjects(state:PlayState_2)
	{
		for (layer in layers)
		{
	...
	function loadObject(state:PlayState_2, o:TiledObject, g:TiledObjectLayer, group:FlxGroup)
	{
		var x:Int = o.x;
		var y:Int = o.y;
